-- Caliper core schema
-- All tables scoped to workspaces (multi-tenant)
...
-- Per-workspace config — API keys stored AES-256-GCM encrypted, decrypted only in backend
...
-- Audit log — mandatory per guideline §1.5, OWASP A09
